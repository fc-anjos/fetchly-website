...
const ICONS: Record<string, React.ReactNode> = {
  lifebuoy: <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M16.712 4.33a9.027 9.027 0 011.652 1.306c.51.51.944 1.064 1.306 1.652M16.712 4.33l-3.448 4.138m3.448-4.138a9.014 9.014 0 00-9.424 0M19.67 7.288l-4.138 3.448m4.138-3.448a9.014 9.014 0 010 9.424m-4.138-5.976a3.736 3.736 0 00-.88-1.388 3.737 3.737 0 00-1.388-.88m2.268 2.268a3.765 3.765 0 010 2.528m-2.268-4.796l-4.138-3.448m4.138 3.448a3.736 3.736 0 01.88 1.388m-4.138-3.448a9.014 9.014 0 010 9.424m.88-7.036a3.765 3.765 0 000 2.528m0 0c.232.65.602 1.24 1.088 1.724m-1.088-1.724l-4.138 3.448m5.226-1.724a9.014 9.014 0 01-9.424 0m5.976-4.138a3.765 3.765 0 00-2.528 0m0 0a3.736 3.736 0 00-1.388.88 3.737 3.737 0 00-.88 1.388m0 0l-3.448-4.138m3.448 4.138a3.765 3.765 0 000 2.528m0 0l-3.448 4.138m0 0a9.027 9.027 0 01-1.306-1.652" /></svg>,
  ...
  refresh: <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182" /></svg>,
...
export function SolutionsGrid({
  ...
  return (
    <Section background="muted" className={cn('py-12 md:py-16', className)}>
      <Container>
